...
module.exports =
{
   ...
   TurnServers : [
		{
			urls : [
				'turn:103.138.96.107:3478?transport=tcp'
			],
			username   : 'coturn',
			credential : 'coturn'
		}
	...
	fileTracker  : '',
	redisOptions : {url :'redis://redis:red_ccAdmin@100@192.168.1.4:30007'},
	...
	mediasoup            :
	{
		...
		webRtcTransport :
		{
			...
			[
				...
				{ ip: '192.168.1.4', announcedIp: null }
